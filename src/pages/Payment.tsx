...
import { Check, Loader2, Phone, User, Shield, ArrowLeft } from "lucide-react";
...
const Payment = () => {
  ...
  const isValid = name.trim().length >= 2 && phone.trim().length >= 9 && provider;
        ...
        <AnimatePresence mode="wait">
            ...
            >
              ...
              <Card className="bg-card border-border">
                <CardHeader className="text-center">
                  ...
                  <CardTitle className="font-display text-3xl text-foreground">COMPLETE PAYMENT</CardTitle>
                ...
                <CardContent className="space-y-5">
                  ...
                  <div className="bg-primary/10 border border-primary/20 rounded-lg p-4 text-center">
                    ...
                    <p className="font-display text-4xl text-primary">ZMW 39</p>
          ...
          {step === "processing" && (
            ...
            >
              ...
              <h2 className="font-display text-3xl text-foreground mb-2">PROCESSING PAYMENT</h2>
          ...
          {step === "success" && (
            ...
            >
              ...
              <h2 className="font-display text-4xl text-foreground mb-2">PAYMENT SUCCESSFUL!</h2>
              <p className="text-muted-foreground mb-6">
                Your payment of ZMW 39 has been received. You now have unlimited access to Stream Net Mirror.
              </p>
              <Button
                size="lg"
